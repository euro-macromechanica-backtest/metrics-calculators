# Euro Macromechanica (EMM) Backtest — Metrics Calculators
*(code-only)*
...
**Калькуляторы метрик** для `fixed_start_100k` и `compounding_eoy_soy_base_100k` под-трэков результатов бэктеста EMM
